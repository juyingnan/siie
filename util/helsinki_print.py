...
STEP_1 = False  # CROSS SECTION
STEP_2 = True  # 2 + 3: move to the center and generate thumb images
STEP_3 = False  # empty
STEP_4 = False  # generate point cloud
STEP_5 = False  # use 3_camera_transform.py to generate point cloud (pickle -> dat) for each image
STEP_6 = False  # generate train and test list
STEP_7 = False  # check if numbers of folder and point cloud are same
...
# generate command
obj_file_root_list = [r'C:\Users\bunny\Desktop\Data',]
...
if STEP_2:
    file = open('../helsinki_model/command/render_step_2.bat', 'w')
    ...
    for output_obj_file in output_obj_list:
        ...
        line = r'"c:\Program Files\Blender Foundation\Blender\blender.exe" ' \
               r'--background --python helsinki_model/helsinki_renderer.py -- ' \
