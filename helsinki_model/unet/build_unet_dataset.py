...
root_dir = r'C:\Users\yiju\Desktop\data'
source_img_path = r"C:\Users\yiju\Desktop\merge.tif"
source_img = io.imread(source_img_path)
source_mask_path = r"C:\Users\yiju\Desktop\merge_db_mask_.tif"
...
for sp in sp_info:
    ...
    while image_count < sp_info[sp]['count']:
        ...
        for function in sp_info[sp]['img']:
            ...
            output_path = os.path.join(root_dir, sp, function, loc + '.tif')
